...
public class DetalleReservaResponse {
  ...
  public DetalleReservaResponse id(Long id) {
    this.id = id;
    return this;
  }
  ...
  */
  ...
  public DetalleReservaResponse habitacionId(Long habitacionId) {
  ...
  */
  ...
  public DetalleReservaResponse precioNoche(Double precioNoche) {
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    DetalleReservaResponse detalleReservaResponse = (DetalleReservaResponse) o;
    return Objects.equals(this.id, detalleReservaResponse.id) &&
        Objects.equals(this.habitacionId, detalleReservaResponse.habitacionId) &&
        Objects.equals(this.precioNoche, detalleReservaResponse.precioNoche);
  }
  ...
  public String toString() {
    ...
    sb.append("class DetalleReservaResponse {\n");
